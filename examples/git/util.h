...
inline bool has_opt(const subparser::boolean_options& options, std::string opt, std::string alt_opt = "") {
...
inline std::optional<std::string> get_value_opt(const subparser::value_options& options, std::string opt, std::string alt_opt = "") {
